    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('post.store') }}" method="POST" id="fileUploadForm"
                        class="form_submit_post" enctype="multipart/form-data">
                        @csrf
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" id="edit_user_id" class="form-control"
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <div class="invalid-feedback"></div>
                                        <div class="progress">
                                            <div class="progress-bar" id="progress-bar-image"
                                                role="progressbar" style="width:" aria-valuenow="100"
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <br>
                                            <input type="checkbox" name="view_main" checked
                                                class="custom-control-input" id="switch_main">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        <div class="custom-control custom-switch">
                                            <br>
                                            <input type="checkbox" name="videoSwitch"
                            ...
                            <div class="row">
                                <div class="col-12 container-file-opt" id="container_video"
                                    style="display: none">
                                    <div class="form-group">
                                        <input type="file" class="form-control" name="video"
                                            id="video">
                                        <div class="progress">
                                            <div class="progress-bar" id="progress-bar-video"
                                                role="progressbar" style="width:" aria-valuenow="100"
                                                aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <div class="invalid-feedback"></div>
                            ...
                            <br>
                            <div class="row">
                                <div class="col-12 container-file-opt" id="container_albom"
                                    style="display: none">
                                    <div class="form-group">
                                        <input type="file" class="form-control" name="albom"
                                            id="albom">
                                        <div class="progress">
                                            <div class="progress-bar" id="progress-bar-albom"
                                                role="progressbar" style="width:" aria-valuenow="100"
                                                aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                        <div class="invalid-feedback"></div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="name">عنوان الخبر</label>
                                        <textarea name="content" id="default1" class="form-control" cols="30" rows="10"></textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                </div>
