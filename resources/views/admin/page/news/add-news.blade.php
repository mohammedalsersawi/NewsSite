                 ...
                 @csrf <div class="card-body">
                     ...
                     <div class="row">
                         <div class="col-6">
                             <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" name="slug" placeholder="عنوان الرابط">
                                 <div class="invalid-feedback"></div>
                             </div>
                         </div>
                         <div class="col-3">
                             ...
                             <div class="form-group">
                                 <div class="custom-control custom-switch">
                                     ...
                                     <input type="checkbox" name="view_main" checked class="custom-control-input"
                                         id="switch_main">
                                     <label class="custom-control-label" for="switch_main">@lang('viewMaim')</label>
                                 </div>
                             </div>
                         </div>
                         <div class="col-4">
                     ...
                     <div class="row">
                         <div class="col-12 container-file-opt" id="container_albom" style="display: none">
                             <div class="form-group">
                                 <input type="file" class="form-control news-albom" name="albom"
                                     id="">
                                 <div class="invalid-feedback"></div>
                                 <div class="progress">
