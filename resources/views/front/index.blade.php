        ...
        <div class="main-panel">
                                    ...
                                    <div class="navbar-collapse justify-content-center collapse"
                                        ...
                                        <ul class="navbar-nav d-lg-flex justify-content-between align-items-center">
                                            ...
                                            <li class="nav-item position-relative">
                                                <a class="nav-link" href="pages/sports.html">Sports
                                                    <ul class="sub-menu">
            ...
            <div class="content-wrapper">
                <div class="container">
                        ...
                        <div class="col-xl-4 stretch-card grid-margin">
                            <div class="card bg-dark text-white">
                                <div class="card-body card-rtl">
                                    ...
                                    <div
                                        class="d-flex border-bottom-blue pt-3 pb-4 align-items-center justify-content-end">
                                        <div class="pl-3">
                                    ...
                                    <div
                                        class="d-flex border-bottom-blue pb-4 pt-4 align-items-center justify-content-end">
                                        <div class="pl-3">
                                            <h5>Virus Kills Member Of Advising Iran’s Supreme</h5>
                                            <div class="fs-12">
                                                <span class="mr-2">Photo </span>10 Minutes ago
                    ...
                    <d iv class="row" data-aos="fade-up">
                    ...
                    <!-- ******************************************************* -->
                    <div class="world-news" data-aos="fade-up">
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-6 grid-margin mb-5 mb-sm-2">
                                <div class="position-relative image-hover">
                                    <img src="assets/images/dashboard/travel.jpg" class="img-fluid"
                                        alt="world-news" />
                            ...
                            <div class="col-lg-3 col-sm-6 mb-5 mb-sm-2">
                                <div class="position-relative image-hover">
                                    <img src="assets/images/dashboard/business.jpg" class="img-fluid"
                                        alt="world-news" />
                    ...
                    <div class="editors-news" data-aos="fade-up">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="d-flex position-relative float-right">
