    ...
    Prism = (function () {
        ...
        if (
            ((a.stringify = function (e, t, r) {
                ...
                if (
                    ("comment" == l.type && (l.attributes.spellcheck = "true"),
                    e.alias)
                ) {
                    var i =
...
(Prism.languages.javascript = Prism.languages.extend("clike", {
    keyword:
        /\b(as|async|await|break|case|catch|class|const|continue|default|delete|do|else|enum|export|extends|finally|for|from|function|get|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|set|static|super|switch|this|throw|try|typeof|var|void|while|with|yield)\b/,
    ...
    for (
        ...
        (s = "string" == typeof s ? { filter: s, language: s } : s),
            e.languages[s.language] &&
                (a["filter-" + s.filter] = {
                    pattern: RegExp(
                        t.replace("{{filter_name}}", s.filter),
                        "m"
                    ),
                    lookbehind: !0,
                    inside: {
            ...
            if (a && /pre/i.test(a.nodeName)) {
                var t,
                    ...
                    r =
                        ...
                        e[s.language] ||
                        s.language.substring(0, 1).toUpperCase() +
                            s.language.substring(1),
                    l = a.previousSibling;
                l &&
                /\s*\bprism-show-language\b\s*/.test(l.className) &&
                l.firstChild &&
                /\s*\bprism-show-language-label\b\s*/.test(
        ...
        Prism.hooks.add("before-sanity-check", function (e) {
            if ("markup" == e.language) {
                ...
                !e.code &&
                    ...
                    (e.element.textContent = e.code =
                        e.element.childNodes[0].textContent);
            }
        }));
})();
!(function () {
                ...
                if (
                    ...
                    for (var i = 0; i < o.length; i++) {
                        var d = o[i].split("-"),
                            ...
                            c = p;
                        if (
                            (2 === d.length && (c = parseInt(d[1])),
                            !isNaN(p) && !isNaN(c))
                        )
                            for (
                                var u = p;
                                c >= u && u <= m.children.length;
                                u++
                            ) {
